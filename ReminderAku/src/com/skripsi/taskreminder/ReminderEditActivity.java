...
import com.skripsi.taskreminder.R;
		...
		mConfirmButton.setOnClickListener(new View.OnClickListener() {
			public void onClick(View view) {
				if(mTitleText.getText().toString().length()==0) {
					mTitleText.setError("Kolom judul tidak boleh kosong");
				}
				else {
					saveState(); 
					setResult(RESULT_OK);
	...
	private void populateFields()  {
		...
		if (mRowId != null) {
			...
			mTitleText.setText(reminder.getString(
					reminder.getColumnIndexOrThrow(RemindersDbAdapter.KEY_JUDUL)));
			mBodyText.setText(reminder.getString(
					reminder.getColumnIndexOrThrow(RemindersDbAdapter.KEY_DETAIL)));
