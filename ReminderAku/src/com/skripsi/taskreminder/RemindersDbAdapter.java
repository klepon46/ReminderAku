...
public class RemindersDbAdapter {
	...
	//
	private static final String DATABASE_NAME = "taskreminders";
    private static final String DATABASE_TABLE = "reminders";
    private static final int DATABASE_VERSION = 6;
    
	public static final String KEY_JUDUL= "judul";
    public static final String KEY_DETAIL = "detail";
    public static final String KEY_DATE_TIME = "tanggal_dan_waktu"; 
    ...
    public long createReminder(String title, String body, String reminderDateTime) {
        ...
        initialValues.put(KEY_JUDUL, title);
        initialValues.put(KEY_DETAIL, body);
    ...
    public Cursor fetchAllReminders() {
        ...
        return mDb.query(DATABASE_TABLE, new String[] {KEY_ROWID, KEY_JUDUL,
                KEY_DETAIL, KEY_DATE_TIME}, null, null, null, null, null);
    }
    ...
    public Cursor fetchReminder(long rowId) throws SQLException {
        ...
        Cursor mCursor =
                ...
                mDb.query(true, DATABASE_TABLE, new String[] {KEY_ROWID,
                        KEY_JUDUL, KEY_DETAIL, KEY_DATE_TIME}, KEY_ROWID + "=" + rowId, null,
                        null, null, null, null);
        if (mCursor != null) {
            mCursor.moveToFirst();
        }
